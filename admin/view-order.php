<!--//When view details is clicked on my orders page.-->
<?php 
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                    <div class="card" style="border:solid; border-color:black; margin-top:-55px;">
                        <div class="card-header" style="background-color:rgb(220,53,69);">
                            <span class="text-white" style="font-size:30px;"> View Order</span>
                                <a href="orders.php" class="btn" style="float:right; background-color:rgb(255,193,7);color:black;"> <i class="fa fa-reply"></i> Back</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <form action="code.php" method="POST">
                                            ...
                                            <button type="submit" name="update_order_btn" class="btn mt-3" style="background-color:rgb(220,53,69); color:white;">Update Order Status</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
